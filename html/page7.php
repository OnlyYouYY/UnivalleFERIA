...
<head>
    ...
    <title>Ingenieria de Sistemas informaticos</title>
</head>
    ...
    <div class="body2">
        ...
        <div class="content">
            <div class="content-showcase animate__animated animate__fadeIn animate__delay-1s">
                <div class="showcase showcase-img7">
                    <h2 class="h2-showcase">Ingenieria de Sistemas informaticos</h2>
